...
/* harmony import */ var _partials_SidebarComp_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../partials/SidebarComp.vue */ "./resources/js/components/partials/SidebarComp.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    SidebarComp: _partials_SidebarComp_vue__WEBPACK_IMPORTED_MODULE_1__["default"],
  ...
  methods: {
    ...
    getFilteredPost: function getFilteredPost(filter_uri, filter_slug) {
      var _this2 = this;

      this.showPagination = false;
      axios.get(this.apiUrl + filter_uri + filter_slug).then(function (response) {
        var rd = response.data.posts;
        _this2.posts = rd;
    ...
    disableCatFilter: function disableCatFilter() {
      this.category_slug = '';
    ...
    disableTagFilter: function disableTagFilter() {
      this.tag_slug = '';
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _data_apiConfig__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../data/apiConfig */ "./resources/js/data/apiConfig.js");
/* harmony import */ var _partials_LoadingComp_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../partials/LoadingComp.vue */ "./resources/js/components/partials/LoadingComp.vue");


/* harmony default export */ __webpack_exports__["default"] = ({
  name: "PostDetailComp",
  components: {
    LoadingComp: _partials_LoadingComp_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  data: function data() {
    return {
      slug: this.$route.params.slug,
      post: [],
      apiUrl: _data_apiConfig__WEBPACK_IMPORTED_MODULE_0__["apiUrl"],
      isLoading: true
    };
  },
  computed: {
  ...
  methods: {
    getApi: function getApi() {
      ...
      axios.get(this.apiUrl + "/dettaglio-post/" + this.slug).then(function (response) {
        var rd = response.data;
        _this.post = rd;

        if (rd.length === _this.post.length) {
          _this.isLoading = false;
        }
      });
    },
...
var render = function render() {
  ...
  }, [_c("main", [_c("router-view")], 1)]), _vm._v(" "), _c("FooterComp")], 1);
};
...
var render = function render() {
  ...
  return _c("div", {
    ...
    on: {
      postsByCategory: _vm.postsByCategory,
      postsByTag: _vm.postsByTag,
      getAllPosts: function getAllPosts($event) {
        return _vm.getApi(1);
      },
      disableCatFilter: _vm.disableCatFilter,
      disableTagFilter: _vm.disableTagFilter
    }
  })], 1);
};
...
var render = function render() {
  ...
  return _c("div", [_vm.isLoading ? _c("LoadingComp") : _c("div", [_c("h1", [_vm._v(_vm._s(_vm.post.title))]), _vm._v(" "), _c("i", [_vm._v(_vm._s(_vm.formatDate))]), _vm._v(" "), _c("p", [_vm._v(_vm._s(_vm.post.content))]), _vm._v(" "), _c("h3", [_vm._v("Categoria: " + _vm._s(_vm.post.category.name))]), _vm._v(" "), _c("h3", [_vm._v("Tags")]), _vm._v(" "), _c("ul", _vm._l(_vm.post.tags, function (tag) {
    return _c("li", {
  ...
  }, [_vm._v("Torna a tutti i post")])], 1)], 1);
};
...
var render = function render() {
  ...
  return _c("header", [_c("ul", {
    staticClass: "list-unstyled d-flex justify-content-center"
  }, [_c("li", {
    staticClass: "mx-2"
  }, [_c("router-link", {
    attrs: {
...
var render = function render() {
  ...
  return _c("div", [_c("ul", [_c("li", [_c("h3", [_c("router-link", {
    attrs: {
      to: {
        name: "detail",
        params: {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    return _c("li", {
      ...
      on: {
        click: function click($event) {
          return _vm.$emit("postsByCategory", category.slug);
        }
      }
    ...
    on: {
      click: function click($event) {
        return _vm.$emit("disableCatFilter");
      }
    }
  }, [_vm._v("Annulla filtro per categoria")])], 2), _vm._v(" "), _c("h3", [_vm._v("TAGS")]), _vm._v(" "), _c("ul", [_vm._l(_vm.tags, function (tag) {
    return _c("li", {
      key: "tag".concat(tag.id),
      on: {
        click: function click($event) {
          return _vm.$emit("postsByTag", tag.slug);
        }
      }
    }, [_vm._v("\n                " + _vm._s(tag.name) + "\n            ")]);
  }), _vm._v(" "), _c("li", {
    on: {
      click: function click($event) {
        return _vm.$emit("disableTagFilter");
      }
    }
  }, [_vm._v("Annulla filtro per tag")])], 2), _vm._v(" "), _c("h3", {
    on: {
      click: function click($event) {
...
// module
exports.push([module.i, ".lds-ripple[data-v-04159c99] {\n  display: inline-block;\n  position: relative;\n  width: 80px;\n  height: 80px;\n}\n.lds-ripple div[data-v-04159c99] {\n  position: absolute;\n  border: 4px solid #fcf;\n  opacity: 1;\n  border-radius: 50%;\n  -webkit-animation: lds-ripple-04159c99 1s cubic-bezier(0, 0.2, 0.8, 1) infinite;\n          animation: lds-ripple-04159c99 1s cubic-bezier(0, 0.2, 0.8, 1) infinite;\n}\n.lds-ripple div[data-v-04159c99]:nth-child(2) {\n  -webkit-animation-delay: -0.5s;\n          animation-delay: -0.5s;\n}\n@-webkit-keyframes lds-ripple-04159c99 {\n0% {\n    top: 36px;\n    left: 36px;\n    width: 0;\n    height: 0;\n    opacity: 0;\n}\n4.9% {\n    top: 36px;\n    left: 36px;\n    width: 0;\n    height: 0;\n    opacity: 0;\n}\n5% {\n    top: 36px;\n    left: 36px;\n    width: 0;\n    height: 0;\n    opacity: 1;\n}\n100% {\n    top: 0px;\n    left: 0px;\n    width: 72px;\n    height: 72px;\n    opacity: 0;\n}\n}\n@keyframes lds-ripple-04159c99 {\n0% {\n    top: 36px;\n    left: 36px;\n    width: 0;\n    height: 0;\n    opacity: 0;\n}\n4.9% {\n    top: 36px;\n    left: 36px;\n    width: 0;\n    height: 0;\n    opacity: 0;\n}\n5% {\n    top: 36px;\n    left: 36px;\n    width: 0;\n    height: 0;\n    opacity: 1;\n}\n100% {\n    top: 0px;\n    left: 0px;\n    width: 72px;\n    height: 72px;\n    opacity: 0;\n}\n}", ""]);
...
// module
exports.push([module.i, "ul li[data-v-33dab28e] {\n  cursor: pointer;\n}\nul li[data-v-33dab28e]:hover {\n  text-decoration: underline;\n}\nh3[data-v-33dab28e] {\n  cursor: pointer;\n}\nh3[data-v-33dab28e]:hover {\n  text-decoration: underline;\n}", ""]);
...
/***/ "./resources/js/data/apiConfig.js":
/*!****************************************!*\
  !*** ./resources/js/data/apiConfig.js ***!
  \****************************************/
...
/* harmony import */ var _components_pages_ContactsComp_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/pages/ContactsComp.vue */ "./resources/js/components/pages/ContactsComp.vue");
/* harmony import */ var _components_pages_BlogComp_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/pages/BlogComp.vue */ "./resources/js/components/pages/BlogComp.vue");
/* harmony import */ var _components_pages_AboutComp_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/pages/AboutComp.vue */ "./resources/js/components/pages/AboutComp.vue");
/* harmony import */ var _components_pages_PostDetailComp_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/pages/PostDetailComp.vue */ "./resources/js/components/pages/PostDetailComp.vue");
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]); // Importo componenti
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    ...
    path: '/chi-siamo',
    name: 'about',
    component: _components_pages_AboutComp_vue__WEBPACK_IMPORTED_MODULE_5__["default"]
  }, {
    path: '/blog',
    name: 'blog',
    component: _components_pages_BlogComp_vue__WEBPACK_IMPORTED_MODULE_4__["default"]
  }, {
    path: '/contatti',
    name: 'contacts',
    component: _components_pages_ContactsComp_vue__WEBPACK_IMPORTED_MODULE_3__["default"]
  }, {
    path: '/dettaglio-post/:slug',
    name: 'detail',
    component: _components_pages_PostDetailComp_vue__WEBPACK_IMPORTED_MODULE_6__["default"]
  }]
...
module.exports = __webpack_require__(/*! C:\Users\inyok\Documents\Programmazione\Boolean\Quinto mese-LARAVEL\LARAVEL\Repository\laravel-boolpress\resources\js\front.js */"./resources/js/front.js");
